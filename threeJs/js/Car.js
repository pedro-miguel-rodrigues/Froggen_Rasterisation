...
function Car(position) {
  ...
  var phong = new THREE.MeshPhongMaterial({color: 0x3d9bb3, emissive: 0x0, specular: 0x878787, shininess: 80});
  var lambert = new THREE.MeshLambertMaterial({color: 0x3d9bb3, emissive: 0x0});
  ...
  this.move = function(delta) {
      ...
      this.mesh.position.add(dir.multiplyScalar(-1 * this.speed*delta));
    };
